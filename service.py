...
FB = None
from lib.util import FORUMS_PATH, FORUMS_STATIC_PATH, CACHE_PATH #analysis:ignore
from main import getForumBrowser, listForumSettings, forumsManager, getNotifyList #analysis:ignore
